...
routerendpoint_map = {'AWSRouter': '/zport/dmd/aws_router',
...
# TODO: use info from YAML files ?
def getendpoint(router):
    if router in routerendpoint_map.keys():
        return routerendpoint_map.get(router)
    else:
